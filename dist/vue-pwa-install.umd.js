(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["vue-pwa-install"] = factory(require("vue"));
	else
		root["vue-pwa-install"] = factory(root["Vue"]);
...
function isBeforeInstallPromptEvent(e) {
...
var VuePwaInstallMixin = external_commonjs_vue_commonjs2_vue_root_Vue_default.a.extend({
  mounted: function mounted() {
    ...
    if ((typeof window === "undefined" ? "undefined" : _typeof(window)) !== undefined) {
      var installHandler = function installHandler(event) {
        if (isBeforeInstallPromptEvent(event)) {
          _this.$emit("canInstall", event);
        }
      };
